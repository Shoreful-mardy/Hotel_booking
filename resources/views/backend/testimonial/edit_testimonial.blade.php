...
<div class="page-content">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <input type="hidden" name="oldimg" value="{{ $tdata->image }}">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-sm-3">
                            ...
                            <div class="form-group col-sm-9 text-secondary">
                                <input type="text" class="form-control" name="name" value="{{ $tdata->name }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-sm-9 text-secondary">
                                <input type="text" class="form-control" name="city" value="{{ $tdata->city }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" name="message" value="{{ $tdata->message }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                            <img id="showImage" src="{{ asset($tdata->image) }}
" alt="testimonial" class="rounded-circle p-1 bg-primary" width="80">
                            </div>
                        </div>
