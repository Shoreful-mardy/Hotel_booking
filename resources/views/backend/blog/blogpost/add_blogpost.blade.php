...
<div class="card-body p-4">
    <form id="myForm" class="row g-3" method="post" action="{{ route('store.blog.post') }}" enctype="multipart/form-data">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group  position-relative input-icon">
                <input type="text" class="form-control" name="post_title" id="input14" placeholder="Post Title">
            </div>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <textarea class="form-control" name="short_desc" id="input23" placeholder="Short Description ..." rows="2"></textarea>
        </div>

        <div class="form-group col-md-12">
            <label for="input23" class="form-label">Long Description</label>
            <textarea class="form-control" name="long_desc" id="mytextarea" placeholder="Description ..." rows="3"></textarea>
        </div>
        ...
        <img id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="image" class="bg-primary" style="width: 100px;">
            </div>
        </div>
