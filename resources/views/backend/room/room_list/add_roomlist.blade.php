    ...
    <div class="col-lg-12">
     ...
     <form method="POST" action="{{ route('store.roomlist') }}" class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <input type="date" name="check_in" class="form-control" id="check_in" placeholder="Check In">
        </div>

        <div class="col-md-4">
            <label for="check_out" class="form-label">Check Out</label>
            <input type="date" name="check_out" class="form-control" id="check_out" placeholder="Check Out">
        </div>



        <div class="col-md-6">
            <label for="number_of_room" class="form-label">Room</label>
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="number_of_person"  id="number_of_person" class="form-control" id="input4">
        </div>
