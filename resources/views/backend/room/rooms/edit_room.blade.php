...
<form class="row g-3" action="{{ route('update.room',$edit_data->id)}}" method="post" enctype="multipart/form-data">
    @csrf

    <div class="col-md-4">
        <label for="input1" class="form-label">Room Type Name</label>
        <input type="text" name="roomtype_id" class="form-control" id="input1" value="{{ $edit_data['type']['name'] }}">
    </div>

    <div class="col-md-4">
        <label for="input2" class="form-label">Totel Adult</label>
        <input type="text" name="total_adult" class="form-control" id="input2" value="{{ $edit_data->total_adult }}">
    </div>

    <div class="col-md-4">
        <label for="input2" class="form-label">Totel Child</label>
        <input type="text" name="total_child" class="form-control" id="input2" value="{{ $edit_data->total_child }}">
    </div>

    <div class="col-md-6">
        <label for="input3" class="form-label">Main Image</label>
        <input type="file" name="image" class="form-control" id="image"  ><br>
        <img id="showImage" src="{{ (!empty($edit_data->image)) ? url('upload/rooming/'.$edit_data->image) : url('upload/no_image.jpg')}}" alt="Room" class="bg-primary" width="60">
    </div>
    ...
    <div class="col-md-3">
        ...
        <input type="text" name="price" class="form-control" id="input1" value="{{ $edit_data->price }}">
    </div>

    <div class="col-md-3">
        <label for="input2" class="form-label">Discount(%)</label>
        <input type="text" name="discount" class="form-control" id="input2" value="{{ $edit_data->discount }}">
    </div>

    <div class="col-md-3">
        <label for="input2" class="form-label">Size</label>
        <input type="text" name="size" class="form-control" id="input2" value="{{ $edit_data->size }}">
    </div>

    <div class="col-md-3">
        <label for="input2" class="form-label">Room Capacity</label>
        <input type="text" name="room_capacity" class="form-control" id="input2" value="{{ $edit_data->room_capacity }}">
    </div>
    ...
    <div class="col-md-12">
        ...
        <textarea class="form-control" name="short_desc" id="input11" placeholder="Short Description ..." rows="3">{{ $edit_data->short_desc }}</textarea>
    </div>

    <div class="col-md-12">
        <label for="input11" class="form-label">Description</label>
        <textarea class="form-control" name="long_desc" id="mytextarea" placeholder="Description ..." rows="3">{!! $edit_data->long_desc !!}</textarea>
    </div>
    ...
    <div class="card-body">
        ...
        <form method="post" action="{{ route('store.room.no',$edit_data->id)}}">
            ...
            <div class="row">
                ...
                <input type="text" name="room_type_no" class="form-control" id="input2">
                 </div>
...
<!--========== Start Room Number Add By the Script ==============-->
<script type="text/javascript">
    $('#roomnoHide').hide();
    $('#roomview').show();
...
<!--========== End  Room Number Add By the Script ==============-->
@endsection