                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="book-img-2">
                            <img src="{{ asset('frontend/assets/img/book-img2.jpg') }}
" alt="Images">
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center pt-45">
                    <div class="col-lg-6 col-md-6">
                        <div class="testimonials-img-two">
                            <img src="{{ asset('frontend/assets/img/testimonials/testimonials-img5.jpg') }}
" alt="Images">
                        </div>
                    </div>
        ...
        <div class="faq-area pt-100 pb-70 section-bg">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="faq-img-3">
                            <img src="{{ asset('frontend/assets/img/faq/faq-img3.jpg') }}
" alt="Images">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item">
                            <a href="blog-details.html">
                                <img src="{{ asset('frontend/assets/img/blog/blog-item-img1.jpg') }}
" alt="Images">
                            </a>
                            <div class="content">
                                <ul>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-item">
                            <a href="blog-details.html">
                                <img src="{{ asset('frontend/assets/img/blog/blog-item-img2.jpg') }}
" alt="Images">
                            </a>
                            <div class="content">
                                <ul>
                    ...
                    <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                        <div class="blog-item">
                            <a href="blog-details.html">
                                <img src="{{ asset('frontend/assets/img/blog/blog-item-img3.jpg') }}
" alt="Images">
                            </a>
                            <div class="content">
                                <ul>
