...
<input autocomplete="off" type="text" name="check_in" id="check_in" required class="form-control dt_picker" value="{{ old('check_in') ? date('Y-m-d',strtotime(old('check_in'))): '' }}">
        ...
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <div class="input-group">
<input autocomplete="off" type="text" name="check_out" id="check_out" required class="form-control dt_picker" value="{{ old('check_out') ? date('Y-m-d',strtotime(old('check_out'))): '' }}">
                    <span class="input-group-addon"></span>
                </div>
                <i class='bx bxs-calendar'></i>
            </div>
        ...
        <input type="hidden" name="total_adult" value="{{ $roomdetails->total_adult }}">
        <input type="hidden" name="room_price" value="{{ $roomdetails->price }}">
        <input type="hidden" name="discount" value="{{ $roomdetails->discount . '%' }}">
                        ...
                        <div class="room-details-article">
                            <div class="room-details-slider owl-carousel owl-theme">
                                ...
                                <div class="room-details-item">
                                    <img src="{{ asset('/upload/rooming/multi_img/'.$item->multi_img)}}" alt="Images">
                                </div>
                                @endforeach
                            </div>
