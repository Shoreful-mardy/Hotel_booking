...
<div class="col-lg-8">
    ...
    <div style="display: flex">
          <img style="height:100px; width:120px;object-fit: cover" src="{{ (!empty($room->image))? url('upload/rooming/'. $room->image) : url('upload/no_image.jpg') }}" alt="Images" alt="Images">
    ...
    <table class="table" style="width: 100%">
    	...
    	@endphp
          ...
          <tr>
                <td><p>Total Night <br><b>( {{ $book_data['check_in'] }} To {{ $book_data['check_out'] }})</b></p></td>
       ...
       <input type="radio" class="pay_method" id="stripe" name="payment_method" value="Stripe">
        ...
        <div class="form-row row">
             ...
             <button type="submit" class="order-btn three" id="myButton">Place to Order</button>
                            </div>
						</div>
					</div>
				</form>
